...
export default function CampaignDetailPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Stats */}
      <div className="bg-card border border-border rounded-xl px-6 py-4 flex items-center gap-8">
        <div>
      ...
      <div className="bg-card border border-border rounded-xl overflow-hidden">
        ...
        {links.length > 0 && (
          <div>
            <div className="grid grid-cols-[1fr_160px_120px] gap-4 px-4 py-2 bg-muted/50 text-xs text-muted-foreground font-medium">
              <span>LINK</span>
              <span>SHORT URL</span>
              <span>ACTIONS</span>
            </div>
            {links.map((link) => (
              <div
                key={link.id}
                className="grid grid-cols-[1fr_160px_120px] gap-4 px-4 py-3 border-t border-border items-center hover:bg-muted/30 transition-colors"
              >
